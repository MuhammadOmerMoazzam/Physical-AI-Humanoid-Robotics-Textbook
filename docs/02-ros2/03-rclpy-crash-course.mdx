---
sidebar_position: 3
title: "rclpy Crash Course – 50 Lines That Move a Humanoid"
---

# Minimal Viable Humanoid Node
...
Run with: `ros2 run humanoid_control joint_publisher.py`

You now have a walking wave motion on any humanoid.